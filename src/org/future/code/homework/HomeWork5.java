...
public class HomeWork5 {
    ...
    */
    ...
    public static class Person {
        ...
        void takeDamage(int damage) throws PersonDead, Exception {
    ...
    public static class Mage extends Person {
        ...
        @Override
        String announce() {
            return "Mage" + getName() + " имеет характеристики:" + health + "здоровья и " + protection + "защиты";
        }
    ...
    public static class Archer extends Person {
        ...
        @Override
        String announce() {
            return " Archer" + getName() + " имеет характеристики:" + health + "здоровья и " + protection + "защиты";
        }
        @Override
